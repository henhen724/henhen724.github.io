...
exports.get = get;
function subscribe(title, identifier, segment, language) {
    if (segment === void 0) { segment = null; }
    if (language === void 0) { language = 'en-US'; }
    return comms_1.graphSubscription("\n    query Player($title: String, $identifier: String, $segment: String) {\n      player(title: $title, id: $identifier, segment: $segment) {\n        id\n        metadata {\n          key\n          name\n          value\n          displayValue\n        }\n        stats {\n          metadata {\n            key\n            name\n            isReversed\n          }\n          value\n          displayValue\n        }\n        segments {\n          metadata {\n            key\n            name\n            value\n            displayValue\n          }\n          stats {\n            metadata {\n              key\n              name\n              isReversed\n            }\n            value\n            displayValue\n          }\n        }\n      }\n    }\n    ", {
        title: title,
        identifier: identifier,
        segment: segment
    }, function (data) { return data.player; }, language);
...
function search(identifier, platform, console, title, comprehensive, exact) {
    if (comprehensive === void 0) { comprehensive = true; }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, comms_1.graphQuery("\n    query Search($platform: String, $console: String, $title: String, $identifier: String, $comprehensive: Boolean, $exact: Boolean) {\n      players(platform: $platform, console: $console, title: $title, identifier: $identifier, comprehensive: $comprehensive, exact: $exact) {\n        results {\n          player {\n            playerId\n            handle\n          }\n          persona {\n            id\n            handle\n            pictureUrl\n            countryCode\n            region\n            isVerified\n            platform {\n              slug\n              name\n            }\n          }\n        }\n      }\n    }\n    ", {
                        ...
                        exact: exact
                    }, function (data) { return data.players; })];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
